                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <c:choose>
                        <c:when test="${empty sessionScope.isAdmin}">
                            ...
                            <li><a href="/user/userHome.do" class="nav-link px-2 text-white" onclick="checkLogin()">마이페이지</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="/admin/admin_home.do" class="nav-link px-2 text-secondary">Home</a></li>
                            <li><a href="/user/userHome.do" class="nav-link px-2 text-white" onclick="checkLogin()">마이페이지</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
